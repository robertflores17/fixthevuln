...
**Pipeline pulse:**
- Daily CVE trigger last output (`data/appsec-review.md`): 2026-09-05 (review date; file mtime 2026-09-07 ✓ — pipeline healthy, NOT P0)
- Friday AI trend roundup last file (`drafts/ai-security-roundup-2026-09-04.md`): 2026-09-04 (Friday ✓ — draft on schedule)
- `data/pending_review.json` pending count: 0 (last_checked: 2026-09-06T17:23:47 UTC ✓)

**New this week:**
- None. No new P0/P1/P2/P3 findings.
- Notable: 10 CVE pages published this week (Google CVE-2026-85046 · BerriAI · Kludex · Kestra · JFrog · Sangoma · SonicWall + 3 others); comparisons freshly regenerated Sep 1; AI roundup draft Sep 4 on schedule; git log shows active daily reconcile pipeline.

**Still open from prior audits:** 8
1. P1 content — `practice-tests/*.html:1` (13 pages) — `<p class="pt-timestamp">Last updated: April 2, 2026</p>` still present (158 days old, **open 13 weeks** — unresolved since June 15 audit) — Fix: remove timestamp block from `scripts/generate_practice_test_pages.py` template; re-run — Effort: XS
2. P2 content — `roadmaps/*.html` (67 pages) — "Last updated: March 30, 2026" — 161 days old — Fix: re-run `python scripts/generate_roadmaps.py` — Effort: XS
...
8. P3 generator drift — `scripts/generate_sitemap.py:60–76` — GUIDE_PAGES missing `ai-agent-security.html` and `genai-data-security.html` (pages ARE in sitemap.xml via reconcile workflow; generate_llms_txt.py GUIDE_PAGES already has both ✓; risk is priority mis-assignment on fresh generate_sitemap.py run; open **9 weeks** unresolved since July 13 audit) — Fix: add both filenames to generate_sitemap.py GUIDE_PAGES set — Effort: XS

**Resolved since last audit:**
- 10 CVE pages published: Google CVE-2026-85046 (Sep 5) · BerriAI, Kludex, Kestra, JFrog, Sangoma, SonicWall + 3 others (Sep 2) ✓
- Blog: 2 new pages published this week (124 total, +2 from 122) ✓
- AI security roundup draft `drafts/ai-security-roundup-2026-09-04.md` generated Friday Sep 4 ✓
- Comparisons regenerated Sep 1, 2026 (now "Last updated: September 1, 2026" ✓)
- Sitemap/llms.txt reconciled daily Aug 31–Sep 7 ✓
- appsec-review.md dated Sep 5; fresh KEV data updated Sep 7 ✓

**Metrics tracked:**
- Total generated pages (cve-*, cert-*, comparisons/*, roadmaps/*): 386 (210 CVE + 66 cert + 43 comparisons + 67 roadmaps) — +10 CVE vs last week (376)
- Blog pages: 124 (was 122, +2 ✓)
- Sitemap entries: 665 (was 653, +12 ✓)
- Evergreen pages with timestamps (should be 0): 13 (practice-tests/*.html only — April 2, 2026 — 158 days, P1 open **13 weeks**)
...
- Certs last updated: August 2, 2026 (36 days — below 90-day threshold ✓) · Comparisons: September 1, 2026 (6 days ✓) · Roadmaps: March 30, 2026 (161 days — P2 open)

---

## 2026-08-31 — Weekly Tech-Debt Audit

**Headline:** Pipeline healthy — 11 CVEs published (200 total milestone), 2 blog posts published, comparisons regenerated Aug 25; `data/appsec-review.md` current today; all 8 prior items still open; P1 practice-tests timestamp now **12 weeks unresolved** at 151 days.

**Pipeline pulse:**
- Daily CVE trigger last output (`data/appsec-review.md`): 2026-08-31 (today ✓ — pipeline fully healthy, NOT P0)
- Friday AI trend roundup last file (`drafts/ai-security-roundup-2026-08-28.md`): 2026-08-28 (Friday ✓ — draft on schedule)
- `data/pending_review.json` pending count: 0 (last_checked: 2026-08-30T18:14:16 UTC ✓)

**New this week:**
- None. No new P0/P1/P2/P3 findings.
- Notable: 200-CVE milestone hit (11 published this week: Oracle Aug 25 + ownCloud/Linux/JFrog/AjaxPro/Red Hat/Citrix/Microsoft/Gitea × 10 on Aug 28); comparisons freshly regenerated Aug 25 (was Aug 18).

**Still open from prior audits:** 8
1. P1 content — `practice-tests/*.html:1` (13 pages) — `<p class="pt-timestamp">Last updated: April 2, 2026</p>` still present (151 days old, **open 12 weeks** — unresolved since June 15 audit) — Fix: remove timestamp block from `scripts/generate_practice_test_pages.py` template; re-run — Effort: XS
2. P2 content — `roadmaps/*.html` (67 pages) — "Last updated: March 30, 2026" — 154 days old — Fix: re-run `python scripts/generate_roadmaps.py` — Effort: XS
3. P2 generator — `scripts/` (14 files >500 LOC, unchanged) — `generate_guides.py` 2,896 · `generate_sprint_kit.py` 1,991 · `fetch_kev.py` 865 · `etsy_to_pinterest.py` 829 · `entity_extractor.py` 765 · `generate_linkedin_posts.py` 716 · `publish_editorial.py` 707 · `audit_pages.py` 661 · `generate_quiz_pages.py` 627 · `generate_cert_pages.py` 595 · `inject_store_ctas.py` 588 · `generate_practice_test_pages.py` 572 · `generate_roadmaps.py` 517 · `generate_cve_pages.py` 504 — Effort: L
...
6. P3 hygiene — `scripts/` (9 instances across 8 scripts) — Broad `except Exception:` without logging: `fetch_kev.py:63`, `generate_sitemap.py:86`, `update_sitemap.py:29`, `audit_pages.py:250,382`, `inject_error_reporter.py:46`, `generate_linkedin_posts.py:72`, `create_hero.py:51`, `health_check.py:127` — Add `logging.exception()` before each — Effort: S
7. P3 hygiene — repo root — No `CLAUDE.md`; editorial rules (evergreen-page timestamp ban, cache-bust policy, pipeline health thresholds) uncodified in-repo — Effort: XS
8. P3 generator drift — `scripts/generate_sitemap.py:60–95` — GUIDE_PAGES missing `ai-agent-security.html` and `genai-data-security.html` (both exist on disk; open **8 weeks** unresolved since July 13 audit) — Fix: add both filenames to GUIDE_PAGES set — Effort: XS

**Resolved since last audit:**
- 11 CVE pages published: Oracle (Aug 25) · ownCloud, Linux, JFrog, AjaxPro, Red Hat, Citrix, Microsoft, Gitea × 10 (Aug 28) ✓
- Blog: `blog/ai-security-roundup-2026-08-21.html` + `blog/weekly-threat-roundup-2026-08-25.html` published ✓
- AI roundup draft `drafts/ai-security-roundup-2026-08-28.md` generated Friday Aug 28 ✓
- Comparisons regenerated Aug 25 (now "Last updated: August 25, 2026" ✓)
- Sprint kit manifest updated Aug 26 ✓
- Sitemap/llms.txt reconciled daily Aug 25–31 ✓

**Metrics tracked:**
- Total generated pages (cve-*, cert-*, comparisons/*, roadmaps/*): 376 (200 CVE + 66 cert + 43 comparisons + 67 roadmaps) — +11 CVE vs last week (365)
- Blog pages: 122 (was 120, +2: ai-security-roundup-2026-08-21.html + weekly-threat-roundup-2026-08-25.html ✓)
- Sitemap entries: 653 (was 640, +13 ✓)
- Evergreen pages with timestamps (should be 0): 13 (practice-tests/*.html only — April 2, 2026 — 151 days, P1 open **12 weeks**)
- Pages missing from llms.txt: 0 ✓
- Cache-bust drift count: 0 (no CSS/JS modified this week ✓)
- Scripts >500 LOC: 14 (unchanged)
- Store worker LOC: 1,331 (unchanged; PRICING 599/1599 cents ↔ $5.99/$15.99 frontend ✓; CP_PRICING 899/1699, 1299/2499, 1699/3499 cents ✓; webhook HMAC signing confirmed at line 717 ✓)
- D1 migrations: 2 (unchanged — 0001_error_log, 0002_quiz_feedback)
- Python scripts with bare `except Exception:` without logging: 9 instances / 8 scripts (unchanged)
- Certs last updated: August 2, 2026 (29 days — note: prior audit Aug 24 stated "August 18" in error; all 66 cert HTML pages show Aug 2) · Comparisons: August 25, 2026 (6 days ✓) · Roadmaps: March 30, 2026 (154 days — P2 open)
...
**Pipeline pulse:**
- Daily CVE trigger last output (`data/appsec-review.md`): 2026-08-12 (5 days old — longest idle gap recorded; `pending_review.json` `last_checked: 2026-08-16T15:10 UTC` with `total_pending: 0` confirms KEV daily fetch IS running; "Update KEV last checked timestamp" commits Aug 12–16 present; no CVEs pending publication, so publish step idle — NOT hard P0 per established precedent; ⚠️ trend: 2-day Aug 3 → 4-day Aug 10 → 5-day Aug 17, watch next week)
- Friday AI trend roundup last file (`drafts/ai-security-roundup-2026-08-14.md`): 2026-08-14 (Friday ✓ — unpublished draft; blog HTML publication scheduled Tuesday Aug 19 per `publish-blog.yml` cron `0 14 * * 2` ✓)
- `data/pending_review.json` pending count: 0 (last_checked: 2026-08-16T15:10:50 UTC ✓)

**New this week:**
- None. No new P0/P1/P2/P3 findings beyond those already tracked.

**Still open from prior audits:** 8
1. P1 content — `practice-tests/*.html:1` (13 pages) — `<p class="pt-timestamp">Last updated: April 2, 2026</p>` still present (137 days old, **open 10 weeks** — unresolved since June 15 audit) — Fix: remove timestamp block from `scripts/generate_practice_test_pages.py` template; re-run — Effort: XS
2. P2 content — `roadmaps/*.html` (67 pages) — "Last updated: March 30, 2026" — 140 days old — Fix: re-run `python scripts/generate_roadmaps.py` — Effort: XS
3. P2 generator — `scripts/` (14 files >500 LOC, unchanged) — `generate_guides.py` 2,896 · `generate_sprint_kit.py` 1,991 · `fetch_kev.py` 865 · `etsy_to_pinterest.py` 829 · `entity_extractor.py` 765 · `generate_linkedin_posts.py` 716 · `publish_editorial.py` 707 · `audit_pages.py` 661 · `generate_quiz_pages.py` 627 · `generate_cert_pages.py` 595 · `inject_store_ctas.py` 588 · `generate_practice_test_pages.py` 572 · `generate_roadmaps.py` 517 · `generate_cve_pages.py` 504 — Effort: L
4. P2 hygiene — repo-wide — `requirements.txt` absent; Pillow (`create_hero.py:4`, `generate_linkedin_posts.py:12`) and reportlab (`generate_sprint_kit.py:31–45`) and requests (`etsy_to_pinterest.py`) undeclared external deps; `security-audit.yml` pip-audit silently no-ops (`requirements.txt` check on line 56 always empty) — Effort: XS
5. P2 SEO — `scripts/generate_sitemap.py:25` — `CONTENT_DIRS` omits `wstg` and `practice-tests` directories; 13+13=26 pages excluded from sitemap.xml entirely — Fix: add `"wstg"` and `"practice-tests"` to CONTENT_DIRS — Effort: XS
6. P3 hygiene — `scripts/` (9 instances across 8 scripts) — Broad `except Exception:` without logging: `fetch_kev.py:63`, `generate_sitemap.py:86`, `update_sitemap.py:29`, `audit_pages.py:250,382`, `inject_error_reporter.py:46`, `generate_linkedin_posts.py:72`, `create_hero.py:51`, `health_check.py:127` — Add `logging.exception()` before each — Effort: S
7. P3 hygiene — repo root — No `CLAUDE.md`; editorial rules (evergreen-page timestamp ban, cache-bust policy, pipeline health thresholds) uncodified in-repo — Effort: XS
8. P3 generator drift — `scripts/generate_sitemap.py:60–95` — GUIDE_PAGES missing `ai-agent-security.html` and `genai-data-security.html` (both exist on disk; open **6 weeks** unresolved since July 13 audit) — Fix: add both filenames to GUIDE_PAGES set — Effort: XS

**Resolved since last audit:**
- 3 CVE pages published: Cisco (CVE-2008-4128) · Microsoft (CVE-2008-4250) · Metabase (CVE-2008-0015) — commit `c483371` Aug 12 ✓
- Blog: `blog/ai-security-roundup-2026-08-07.html` + `blog/weekly-threat-roundup-2026-08-11.html` published ✓
- AI roundup draft `drafts/ai-security-roundup-2026-08-14.md` generated Aug 14 (Friday ✓) via commit `f145297` — blog HTML pending Aug 19 publish cycle ✓
- Sitemap/llms.txt reconciled daily Aug 11–17; llms.txt updated Aug 16 (commit `e851f95`) ✓

**Metrics tracked:**
- Total generated pages (cve-*, cert-*, comparisons/*, roadmaps/*): 356 (180 CVE + 66 cert + 43 comparisons + 67 roadmaps) — +3 CVE vs last week (353)
- Blog pages: 118 (was 116, +2: ai-security-roundup-2026-08-07.html + weekly-threat-roundup-2026-08-11.html ✓)
- Sitemap entries: 629 (was 624, +5 ✓)
- Evergreen pages with timestamps (should be 0): 13 (practice-tests/*.html only — April 2, 2026 — 137 days, P1 open **10 weeks**)
- Pages missing from llms.txt: 0 ✓
- Cache-bust drift count: 0 (no CSS/JS modified this week ✓)
- Scripts >500 LOC: 14 (unchanged; `STYLE_CSS_VERSION=8`, `QUIZ_CSS_VERSION=3`, `COMPARISON_CSS_VERSION=3` — no bumps needed)
- Store worker LOC: 1,331 (unchanged; PRICING 599/1599 cents ↔ $5.99/$15.99 frontend ✓; CP_PRICING 899/1699, 1299/2499, 1699/3499 cents ✓; webhook HMAC signing confirmed at line 694 ✓)
- D1 migrations: 2 (unchanged — 0001_error_log, 0002_quiz_feedback)
- Python scripts with bare `except Exception:` without logging: 9 instances / 8 scripts (unchanged)
- certs Last updated: August 2, 2026 (15 days ✓) · comparisons Last updated: August 11, 2026 (6 days ✓) · roadmaps: March 30, 2026 (140 days — P2 open)

---

## 2026-08-10 — Weekly Tech-Debt Audit

**Headline:** Pipeline healthy — 6 CVEs published (177 total), 2 blog posts published (ai-security-roundup-2026-07-31 + weekly-threat-roundup-2026-08-04); no new material findings; all 8 prior items remain open; P1 practice-tests timestamp now 9 weeks unresolved at 130 days.

**Pipeline pulse:**
- Daily CVE trigger last output (`data/appsec-review.md`): 2026-08-08 (2 days old — at threshold; `pending_review.json` `last_checked: 2026-08-09T15:20 UTC` with `total_pending: 0` confirms KEV daily fetch IS running; "Update KEV last checked timestamp" commit Aug 9 present; pipeline idle not stalled ✓ NOT P0 — same weekend-quiet pattern as prior audits)
- Friday AI trend roundup last file (`drafts/ai-security-roundup-2026-08-07.md`): 2026-08-07 (Thursday — draft only, no .published suffix; scheduled blog publish Tuesday Aug 12 per `publish-blog.yml` cron `0 14 * * 2` ✓)
- `data/pending_review.json` pending count: 0 (last_checked: 2026-08-09T15:20:09 UTC ✓)

**New this week:**
- None. No new P0/P1/P2/P3 findings.

**Still open from prior audits:** 8
1. P1 content — `practice-tests/*.html:1` (13 pages) — `<p class="pt-timestamp">Last updated: April 2, 2026</p>` still present (130 days old, open **9 weeks** — unresolved since June 22 audit) — Fix: remove timestamp block from `scripts/generate_practice_test_pages.py` template; re-run — Effort: XS
2. P2 content — `roadmaps/*.html` (67 pages) — "Last updated: March 30, 2026" — 133 days old (unresolved since July 20 audit) — Fix: re-run `python scripts/generate_roadmaps.py` — Effort: XS
3. P2 generator — `scripts/` (14 files >500 LOC, unchanged) — `generate_guides.py` 2,896 · `generate_sprint_kit.py` 1,991 · `fetch_kev.py` 865 · `etsy_to_pinterest.py` 829 · `entity_extractor.py` 765 · `generate_linkedin_posts.py` 716 · `publish_editorial.py` 707 · `audit_pages.py` 661 · `generate_quiz_pages.py` 627 · `generate_cert_pages.py` 595 · `inject_store_ctas.py` 588 · `generate_practice_test_pages.py` 572 · `generate_roadmaps.py` 517 · `generate_cve_pages.py` 504 — Effort: L
4. P2 hygiene — repo-wide — `requirements.txt` absent; Pillow (`create_hero.py:4`, `generate_linkedin_posts.py:12`) and reportlab (`generate_sprint_kit.py:33–45`) and requests (`etsy_to_pinterest.py`) undeclared external deps; `security-audit.yml` pip-audit silently no-ops — Effort: XS
5. P2 SEO — `scripts/generate_sitemap.py:25` — `CONTENT_DIRS = ["blog", "certs", "comparisons", "roadmaps", "cve", "store"]` omits `wstg` and `practice-tests` directories; 13+13=26 pages excluded from sitemap.xml entirely — Fix: add `"wstg"` and `"practice-tests"` to CONTENT_DIRS — Effort: XS
6. P3 hygiene — `scripts/` (9 instances across 8 scripts) — Broad `except Exception:` without logging: `fetch_kev.py:63`, `generate_sitemap.py:86`, `update_sitemap.py:29`, `audit_pages.py:250,382`, `inject_error_reporter.py:46`, `generate_linkedin_posts.py:72`, `create_hero.py:51`, `health_check.py:127` — Add `logging.exception()` before each — Effort: S
7. P3 hygiene — repo root — No `CLAUDE.md`; editorial rules (evergreen-page timestamp ban, cache-bust policy, pipeline health thresholds) uncodified in-repo — Effort: XS
8. P3 generator drift — `scripts/generate_sitemap.py:60–95` — GUIDE_PAGES missing `ai-agent-security.html` and `genai-data-security.html` (both exist on disk; open **5 weeks** unresolved since July 13 audit) — Fix: add both filenames to the GUIDE_PAGES set — Effort: XS

**Resolved since last audit:**
- 6 CVE pages published: N-able N-central (Aug 4) · N-able/Apache/IBM Langflow (Aug 5) · JetBrains TeamCity (Aug 7) · Progress LoadMaster (Aug 8) ✓
- Blog: `blog/ai-security-roundup-2026-07-31.html` + `blog/weekly-threat-roundup-2026-08-04.html` published via Aug 5 Tuesday cycle ✓
- Sitemap/llms.txt reconciled daily Aug 4–10 ✓

**Metrics tracked:**
- Total generated pages (cve-*, cert-*, comparisons/*, roadmaps/*): 353 (177 CVE + 66 cert + 43 comparisons + 67 roadmaps) — +6 CVE vs last week (347)
- Blog pages: 116 (was 114, +2: ai-security-roundup-2026-07-31.html + weekly-threat-roundup-2026-08-04.html ✓)
- Sitemap entries: 624 (was 616, +8 ✓)
- Evergreen pages with timestamps (should be 0): 13 (practice-tests/*.html only — April 2, 2026 — 130 days, P1 open 9 weeks)
- Pages missing from llms.txt: 0 ✓
- Cache-bust drift count: 0 (no CSS/JS modified this week ✓)
- Scripts >500 LOC: 14 (unchanged)
- Store worker LOC: 1,331 (unchanged; PRICING 599/1599 cents ↔ $5.99/$15.99 frontend ✓; CP_PRICING 899/1699, 1299/2499, 1699/3499 cents ✓; webhook HMAC signing confirmed ✓)
...
## 2026-08-03 — Weekly Tech-Debt Audit

**Headline:** Pipeline healthy — 3 CVEs published (171 total), cert pages regenerated Aug 2 (P2 resolved), worker grew +180 LOC for quiz-analytics + classifier-feedback routes (commented, auth in place); P1 practice-tests timestamp now 7 weeks unresolved at 124 days; 8 items still open.

**Pipeline pulse:**
- Daily CVE trigger last output (`data/appsec-review.md`): 2026-07-30 (4 days old — triggers >2-day P0 rule; mitigating: `pending_review.json` `last_checked: 2026-08-02T15:52 UTC` with `total_pending: 0`; "Update KEV last checked timestamp" commits Aug 1 + Aug 2 confirm daily fetch running; pipeline idle not stalled ✓ NOT hard P0 — same pattern as July 6 and July 20 audits)
- Friday AI trend roundup last file (`drafts/ai-security-roundup-2026-07-31.md`): 2026-07-31 (draft only, no .published suffix — publishes Tuesday Aug 5 per `publish-blog.yml` cron `0 14 * * 2` ✓)
- `data/pending_review.json` pending count: 0 (last_checked: 2026-08-02T15:52:06 UTC ✓)

**New this week:**
- P2 worker growth — `store/cloudflare-worker.js` — LOC grew from 1,151 to 1,331 (+180 lines, 16%) via commit `9c68678` (Aug 1): added `/quiz-analytics` (ADMIN_KEY-protected) and `/classifier-feedback` (rate-limited 10/min/IP) D1 routes. New code paths have section-header comments. `classifier_feedback` table already in `store/migrations/0002_quiz_feedback.sql` ✓. PRICING unchanged (599/1599 cents). No new D1 migrations needed. Effort: monitor growth trajectory — Effort: XS

**Still open from prior audits:** 8
1. P1 content — `practice-tests/*.html:1` (13 pages) — `<p class="pt-timestamp">Last updated: April 2, 2026</p>` still present (124 days old, open **7 weeks** — unresolved since June 15 audit) — Fix: remove timestamp block from `scripts/generate_practice_test_pages.py` template; re-run — Effort: XS
2. P2 content — `roadmaps/*.html` (67 pages) — "Last updated: March 30, 2026" — 157 days old (cert pages were fixed Aug 2 but roadmaps were not regenerated) — Fix: re-run `python scripts/generate_roadmaps.py` — Effort: XS
3. P2 generator — `scripts/` (14 files >500 LOC, unchanged) — `generate_guides.py` 2,896 · `generate_sprint_kit.py` 1,991 · `fetch_kev.py` 865 · `etsy_to_pinterest.py` 829 · `entity_extractor.py` 765 · `generate_linkedin_posts.py` 716 · `publish_editorial.py` 707 · `audit_pages.py` 661 · `generate_quiz_pages.py` 627 · `generate_cert_pages.py` 595 · `inject_store_ctas.py` 588 · `generate_practice_test_pages.py` 572 · `generate_roadmaps.py` 517 · `generate_cve_pages.py` 504 — Effort: L
4. P2 hygiene — repo-wide — `requirements.txt` absent; Pillow (`create_hero.py:4`, `generate_linkedin_posts.py:12`) and reportlab (`generate_sprint_kit.py`) and requests (`etsy_to_pinterest.py`) undeclared external deps; `security-audit.yml` pip-audit silently no-ops — Effort: XS
5. P2 SEO — `scripts/generate_sitemap.py:25` — `CONTENT_DIRS = ["blog", "certs", "comparisons", "roadmaps", "cve", "store"]` omits `wstg` and `practice-tests` directories; 13+13=26 pages excluded from sitemap.xml entirely — Fix: add `"wstg"` and `"practice-tests"` to CONTENT_DIRS — Effort: XS
6. P3 hygiene — `scripts/` (9 instances across 8 scripts) — Broad `except Exception:` without logging: `fetch_kev.py:63`, `generate_sitemap.py:86`, `update_sitemap.py:29`, `audit_pages.py:250,382`, `inject_error_reporter.py:46`, `generate_linkedin_posts.py:72`, `create_hero.py:51`, `health_check.py:127` — Add `logging.exception()` before each — Effort: S
7. P3 hygiene — repo root — No `CLAUDE.md`; editorial rules (evergreen-page timestamp ban, cache-bust policy, pipeline health thresholds) uncodified in-repo — Effort: XS
8. P3 generator drift — `scripts/generate_sitemap.py:60–95` — GUIDE_PAGES missing `ai-agent-security.html` and `genai-data-security.html` (both exist on disk; `ai-agent-security-threats.html` was added but is a distinct third page); open **4 weeks** unresolved — Fix: add both filenames to the GUIDE_PAGES set — Effort: XS

**Resolved since last audit:**
- P2 content — `certs/*.html` (66 pages) — "Last updated: August 2, 2026" after commit `e4f3721` (Aug 2); also fixed ISACA member/non-member pricing bug ✓
- 3 CVE pages published: Arista (July 28) · Fortinet (July 28) · Cisco (July 30) ✓
- Blog: `blog/ai-security-roundup-2026-07-24.html` + `blog/weekly-threat-roundup-2026-07-28.html` published ✓
- Store worker: `/quiz-analytics` + `/classifier-feedback` D1 routes implemented (commit `9c68678`, Aug 1) — `analytics.html` and `vuln-classifier.html` 404s resolved ✓
- Sitemap/llms.txt reconciled Aug 1–2 ✓

**Metrics tracked:**
- Total generated pages (cve-*, cert-*, comparisons/*, roadmaps/*): 347 (171 CVE + 66 cert + 43 comparisons + 67 roadmaps) — +3 CVE vs last week (344)
- Blog pages: 114 (was 112, +2: ai-security-roundup-2026-07-24.html + weekly-threat-roundup-2026-07-28.html ✓)
- Sitemap entries: 616 (was 611, +5 ✓)
- Evergreen pages with timestamps (should be 0): 13 (practice-tests/*.html only — April 2, 2026 — 124 days, P1 open 7 weeks)
- Pages missing from llms.txt: 0 (171 CVE ✓ · 114 blog ✓ · 66 cert ✓ · 43 comp ✓ · 67 roadmaps ✓)
- Cache-bust drift count: 0 (no CSS/JS modified this week ✓)
- Scripts >500 LOC: 14 (unchanged)
- Store worker LOC: 1,331 (+180 vs last week 1,151; new /quiz-analytics + /classifier-feedback routes; PRICING 599/1599 cents ↔ $5.99/$15.99 frontend ✓; CP_PRICING 899/1699, 1299/2499, 1699/3499 cents ✓)
- D1 migrations: 2 (unchanged — classifier_feedback table already in 0002_quiz_feedback.sql ✓)
- Python scripts with bare `except Exception:` without logging: 9 instances / 8 scripts (unchanged)

---

## 2026-07-27 — Weekly Tech-Debt Audit

**Headline:** Pipeline healthy — 6 CVEs published this week (168 total), AI roundup on schedule; one new P2 (wstg/ and practice-tests/ absent from `CONTENT_DIRS` in generate_sitemap.py — 26 pages missing from sitemap.xml); 8 items still open; P1 practice-tests timestamp now 6 weeks unresolved.

**Pipeline pulse:**
- Daily CVE trigger last output (`data/appsec-review.md`): 2026-07-25 (file modified — exactly 2 days, at threshold; content date 2026-07-23; 2 CVEs published July 24 ✓; `pending_review.json` `last_checked: 2026-07-26T15:53 UTC` with `total_pending: 0` ✓; HEALTHY)
- Friday AI trend roundup last file (`drafts/ai-security-roundup-2026-07-24.md`): 2026-07-24 (draft committed July 25; blog HTML scheduled for Tuesday July 28 per `publish-blog.yml` cron `0 14 * * 2` ✓)
- `data/pending_review.json` pending count: 0 ✓

**New this week:**
- P2 SEO — `scripts/generate_sitemap.py:25` — `CONTENT_DIRS = ["blog", "certs", "comparisons", "roadmaps", "cve", "store"]` omits `wstg` and `practice-tests` directories; 13+13=26 pages excluded from sitemap.xml entirely — Fix: add `"wstg"` and `"practice-tests"` to CONTENT_DIRS (priority 0.7/monthly for both) and re-run reconcile — Effort: XS

**Still open from prior audits:** 8
1. P1 content — `practice-tests/*.html:352` (13 pages) — `<p class="pt-timestamp">Last updated: April 2, 2026</p>` — 116 days old, open **6 weeks** (unresolved since June 15 audit) — Fix: remove timestamp block from `scripts/generate_practice_test_pages.py` template; re-run — Effort: XS
2. P2 content — `certs/*.html` (66 pages) — "Last updated: March 31, 2026" — 118 days old (new last week) — Fix: re-run `python scripts/generate_cert_pages.py` — Effort: XS
3. P2 content — `roadmaps/*.html` (67 pages) — "Last updated: March 30, 2026" — 119 days old (new last week) — Fix: re-run `python scripts/generate_roadmaps.py` — Effort: XS
4. P2 generator — `scripts/` (14 files >500 LOC, unchanged) — `generate_guides.py` 2,896 · `generate_sprint_kit.py` 1,991 · `fetch_kev.py` 865 · `etsy_to_pinterest.py` 829 · `entity_extractor.py` 765 · `generate_linkedin_posts.py` 716 · `publish_editorial.py` 707 · `audit_pages.py` 661 · `generate_quiz_pages.py` 627 · `generate_cert_pages.py` 595 · `inject_store_ctas.py` 588 · `generate_practice_test_pages.py` 572 · `generate_roadmaps.py` 517 · `generate_cve_pages.py` 504 — Effort: L
5. P2 hygiene — repo-wide — `requirements.txt` absent; Pillow (`create_hero.py:4`, `generate_linkedin_posts.py:12`) and reportlab (`generate_sprint_kit.py`) and requests (`etsy_to_pinterest.py`) undeclared external deps; `security-audit.yml` pip-audit silently no-ops — Effort: XS
6. P3 hygiene — `scripts/` (9 instances across 8 scripts) — Broad `except Exception:` without logging: `fetch_kev.py:63`, `generate_sitemap.py:86`, `update_sitemap.py:29`, `audit_pages.py:250,382`, `inject_error_reporter.py:46`, `generate_linkedin_posts.py:72`, `create_hero.py:51`, `health_check.py:127` — Add `logging.exception()` before each — Effort: S
7. P3 hygiene — repo root — No `CLAUDE.md`; editorial rules (evergreen-page timestamp ban, cache-bust policy, pipeline health thresholds) uncodified in-repo — Effort: XS
8. P3 generator drift — `scripts/generate_sitemap.py:72` — GUIDE_PAGES missing `ai-agent-security.html` and `genai-data-security.html` (open 3 weeks) — Effort: XS

**Resolved since last audit:**
- 6 CVE pages published: WordPress, Langflow, DD-WRT (July 22) + Check Point, Microsoft SharePoint (July 24) ✓
- `blog/weekly-threat-roundup-2026-07-21.html` published ✓
- `blog/ai-security-roundup-2026-07-17.html` published (was draft-only as of July 20 audit) ✓
- Sitemap/llms.txt reconciled daily July 21–26 ✓

**Metrics tracked:**
- Total generated pages (cve-*, cert-*, comparisons/*, roadmaps/*): 344 (168 CVE + 66 cert + 43 comparisons + 67 roadmaps) — +6 CVE vs last week (338)
- Blog pages: 112 (was 110, +2 ✓; ai-security-roundup-2026-07-24.md draft — publishes Tuesday July 28)
- Sitemap entries: 611 (was 603, +8 ✓)
- Evergreen pages with timestamps (should be 0): 13 (practice-tests/*.html only — April 2, 2026 — 116 days, P1 open 6 weeks)
- Pages missing from llms.txt: 0 (llms.txt page counts verified against disk: 168 CVE · 66 cert · 43 comp · 67 roadmaps · 112 blog ✓)
- Cache-bust drift count: 0 (no CSS/JS modified this week ✓)
- Scripts >500 LOC: 14 (unchanged)
- Store worker LOC: 1,151 (unchanged; HMAC webhook signing confirmed ✓; PRICING 599/1599 cents ↔ $5.99/$15.99 frontend ✓; CP_PRICING 899/1699, 1299/2499, 1699/3499 cents ✓)
- D1 migrations: 2 (unchanged — 0001_error_log, 0002_quiz_feedback)
- Python scripts with bare `except Exception:` without logging: 9 instances / 8 scripts (unchanged)

---

## 2026-07-20 — Weekly Tech-Debt Audit

**Headline:** Active CVE week — 10 new CVE pages (162 total, highest single-week gain in audit history); pipeline healthy with weekend-quiet pattern; 2 new blog posts published (ai-security-roundup-2026-07-10 + weekly-threat-roundup-2026-07-14); 2 new P2 findings: cert pages (66) and roadmap pages (67) both >110 days stale — never previously caught; P1 practice-tests timestamp now open 5 weeks with no fix.

**Pipeline pulse:**
- Daily CVE trigger last output (`data/appsec-review.md`): 2026-07-17 (content date — 3 days old; `pending_review.json` `last_checked: 2026-07-19T15:44:32 UTC` with `total_pending: 0`; 10 CVEs published July 14–17; weekend-quiet pattern — pipeline healthy ✓ NOT P0)
- Friday AI trend roundup last file (`drafts/ai-security-roundup-2026-07-17.md`): 2026-07-17 (draft only, no .published suffix — appears to be a manual/advance trigger since July 17 is Thursday; scheduled blog publish Tuesday July 22 per publish-blog.yml cron `0 14 * * 2` ✓)
- `data/pending_review.json` pending count: 0 (last_checked: 2026-07-19T15:44:32 UTC ✓)

**New this week:**
- P2 content — `certs/*.html:140` (66 pages) — "Last updated: March 31, 2026" — 111 days old, exceeds the 90-day auto-regeneration threshold; never flagged in prior audits (was exactly at threshold June 29; missed July 6 and July 13 — first time captured here) — Fix: re-run `python scripts/generate_cert_pages.py` and commit; consider adding cert-page regeneration to Tuesday publish-blog.yml — Effort: XS (one-off run) / S (automate in pipeline)
- P2 content — `roadmaps/*.html:137` (67 pages) — "Last updated: March 30, 2026" — 112 days old, same threshold breach; comparisons pages are fresh (July 14 ✓) but roadmaps/certs not — Fix: re-run `python scripts/generate_roadmaps.py` and commit — Effort: XS

**Still open from prior audits:** 6
1. P1 content — `practice-tests/*.html:352` (13 pages) — `<p class="pt-timestamp">Last updated: April 2, 2026</p>` still present (109 days old, open **5 weeks**). Fix: remove timestamp block from `scripts/generate_practice_test_pages.py` template; re-run — Effort: XS
2. P2 generator — `scripts/` (14 files >500 LOC, unchanged) — `generate_guides.py` 2,896 · `generate_sprint_kit.py` 1,991 · `fetch_kev.py` 865 · `etsy_to_pinterest.py` 829 · `entity_extractor.py` 765 · `generate_linkedin_posts.py` 716 · `publish_editorial.py` 707 · `audit_pages.py` 661 · `generate_quiz_pages.py` 627 · `generate_cert_pages.py` 595 · `inject_store_ctas.py` 588 · `generate_practice_test_pages.py` 572 · `generate_roadmaps.py` 517 · `generate_cve_pages.py` 504 — Effort: L
3. P2 hygiene — repo-wide — `requirements.txt` absent; Pillow (`create_hero.py:4`, `generate_linkedin_posts.py:12`) and reportlab (`generate_sprint_kit.py`) undeclared external deps; `security-audit.yml` pip-audit silently no-ops — Effort: XS
4. P3 hygiene — `scripts/` (9 instances across 8 scripts) — Broad `except Exception:` without logging: `fetch_kev.py:63`, `generate_sitemap.py:86`, `update_sitemap.py:29`, `audit_pages.py:250,382`, `inject_error_reporter.py:46`, `generate_linkedin_posts.py:72`, `create_hero.py:51`, `health_check.py:127` — Effort: S
5. P3 hygiene — repo root — No `CLAUDE.md`; editorial rules uncodified in-repo — Effort: XS
6. P3 generator drift — `scripts/generate_sitemap.py:72` — GUIDE_PAGES missing `ai-agent-security.html` and `genai-data-security.html` (both present in `generate_llms_txt.py:154`); these pages get sitemap priority 0.7 instead of 0.8 — open 1 week, unresolved — Effort: XS

**Resolved since last audit:**
- ai-security-roundup-2026-07-10.html published to blog/ (was draft only as of July 13 audit ✓)
- weekly-threat-roundup-2026-07-14.html published to blog/ ✓
- 10 new CVE pages published July 14–17: Cisco (July 14) · 4× Microsoft/SonicWall (July 15) · Oracle + KNX Association (July 16) · 3× Microsoft/Fortinet (July 17) ✓
- sitemap/llms.txt reconciled daily July 14–20 ✓

**Metrics tracked:**
- Total generated pages (cve-*, cert-*, comparisons/*, roadmaps/*): 338 (162 CVE + 66 cert + 43 comparisons + 67 roadmaps) — +10 CVE vs last week (328)
- Blog pages: 110 (was 108, +2: ai-security-roundup-2026-07-10.html + weekly-threat-roundup-2026-07-14.html)
- Sitemap entries: 603 (was 591, +12 ✓)
- Evergreen pages with timestamps (should be 0): 13 (practice-tests/*.html only — April 2, 2026 — 109 days, P1 open 5 weeks)
- Pages missing from llms.txt: 0 (llms.txt counts match on-disk: 162 CVE · 66 cert · 43 comp · 67 roadmaps · 110 blog ✓)
- Cache-bust drift count: 0 (no CSS/JS modified this week ✓)
- Scripts >500 LOC: 14 (unchanged)
- Store worker LOC: 1,151 (unchanged; `verifyStripeSignature` HMAC at line 659 confirmed ✓; PRICING 599/1599 cents ↔ $5.99/$15.99 frontend ✓; CP_PRICING 899/1699, 1299/2499, 1699/3499 cents ✓)
