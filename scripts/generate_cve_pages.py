...
<div class="share-bar">
    ...
    <main class="container">
        ...
        <section style="background: linear-gradient(135deg, #1a1a2e 0%, #16213e 100%); padding: 1.5rem; border-radius: 10px; color: white; margin-top: 2rem; text-align: center;">
            ...
            <p style="opacity: 0.9; margin-bottom: 1rem;">Structured study planners for 30+ security certifications. Master vulnerability management with domain trackers and exam strategies.</p>
