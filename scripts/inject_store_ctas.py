...
COMPARISON_MAP = {
    ...
    # New comparisons (25)
    'cc-vs-security-plus.html':                 [('isc2-cc', 'ISC2 CC'), ('comptia-security-plus', 'CompTIA Security+')],
    'gsec-vs-security-plus.html':               [('giac-gsec', 'GIAC GSEC'), ('comptia-security-plus', 'CompTIA Security+')],
    'oscp-vs-ceh.html':                         [('offsec-oscp', 'OffSec OSCP'), ('ec-ceh', 'EC-Council CEH')],
    'oscp-vs-pentest-plus.html':                [('offsec-oscp', 'OffSec OSCP'), ('comptia-pentest-plus', 'CompTIA PenTest+')],
    'sc-900-vs-security-plus.html':             [('ms-sc-900', 'Microsoft SC-900'), ('comptia-security-plus', 'CompTIA Security+')],
    'casp-plus-vs-pentest-plus.html':           [('comptia-casp-plus', 'CompTIA CASP+'), ('comptia-pentest-plus', 'CompTIA PenTest+')],
    'cloud-plus-vs-security-plus.html':         [('comptia-cloud-plus', 'CompTIA Cloud+'), ('comptia-security-plus', 'CompTIA Security+')],
    'linux-plus-vs-network-plus.html':          [('comptia-linux-plus', 'CompTIA Linux+'), ('comptia-network-plus', 'CompTIA Network+')],
    'data-plus-vs-security-plus.html':          [('comptia-data-plus', 'CompTIA Data+'), ('comptia-security-plus', 'CompTIA Security+')],
    'sscp-vs-cissp.html':                       [('isc2-sscp', 'ISC2 SSCP'), ('isc2-cissp', 'ISC2 CISSP')],
    'ccsp-vs-cissp.html':                       [('isc2-ccsp', 'ISC2 CCSP'), ('isc2-cissp', 'ISC2 CISSP')],
    ...
    'az-204-vs-az-305.html':                    [('ms-az-204', 'Microsoft AZ-204'), ('ms-az-305', 'Microsoft AZ-305')],
    'ccna-vs-cyberops.html':                    [('cisco-ccna', 'Cisco CCNA'), ('cisco-cyberops', 'Cisco CyberOps')],
    'ccnp-encor-vs-ccna.html':                  [('cisco-ccnp-encor', 'Cisco CCNP ENCOR'), ('cisco-ccna', 'Cisco CCNA')],
    'gcp-ace-vs-aws-clf.html':                  [('google-ace', 'Google Cloud ACE'), ('aws-cloud-practitioner', 'AWS Cloud Practitioner')],
    'cka-vs-az-104.html':                       [('k8s-cka', 'Kubernetes CKA'), ('ms-az-104', 'Microsoft AZ-104')],
    'terraform-vs-az-104.html':                 [('hashicorp-terraform', 'HashiCorp Terraform'), ('ms-az-104', 'Microsoft AZ-104')],
    'ckad-vs-cka.html':                         [('k8s-ckad', 'Kubernetes CKAD'), ('k8s-cka', 'Kubernetes CKA')],
}
